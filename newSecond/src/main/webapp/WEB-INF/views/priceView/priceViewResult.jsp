    ...
    <main>
            ...
            <section class="priceViewResult--background">
                ...
                <div class="priceViewResult--main__box">
                    <div class="priceViewResult--main__SearchBox">
                        <input type="text" value="아이폰12"><button type="submit">검색</button>
                    </div>
        ...
        <section class="content--priceViewResult__bottomBackground">
            ...
            <section class="content--priceViewResult__bottomMain">
                <aside class="content--aside__bLeft">left</aside>

                <section class="priceViewResult--bBackground">
                    <div class="priceViewResult--main__bBox">

                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-1.jpg">
                            <div>120,000원</div>
                            <div>아이폰12 부품용 싸게 팝니다!</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-2.jfif">
                            <div>500,000원</div>
                            <div>아이폰12 싸게 팝니다</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-3.jpg">
                            <div>450,000원</div>
                            <div>[iPhone12] 아이폰12 128GB 화이트 공기계</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-4.jpg">
                            <div>780,000원</div>
                            <div>아이폰12 프로 256기가 퍼시픽블루 S급</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-5.jfif">
                            <div>480,000원</div>
                            <div>아이폰 12 64기가 Iphone 12</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-6.jpg">
                            <div>700,000원</div>
                            <div>아이폰12 프로 맥스 128g 최상급</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-7.jpg">
                            <div>470,000원</div>
                            <div>아이폰12 스페이스그레이</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-8.jpg">
                            <div>650,000원</div>
                            <div>아이폰 12프로 512기가 퍼시픽 블루 iphone 12 pro</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-9.jfif">
                            <div>700,000원</div>
                            <div>아이폰12프로 128g iPhone 12 pro 퍼시픽블루 s급</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-10.jfif">
                            <div>650,000원</div>
                            <div>아이폰 12프로 맥스 256GB (iphone 12pro max) 자급제 A급</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-11.jfif">
                            <div>500,000원</div>
                            <div>아이폰12프로(12pro) 실버 128기가 판매합니다</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-12.jpg">
                            <div>600,000원</div>
                            <div>아이폰12 프로맥스 골드 (iPhone 12 pro max gold) 256기가</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-13.jpg">
                            <div>580,000원</div>
                            <div>아이폰 12 풀구성 X,Xs,12프로,13,13프로</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-14.jpg">
                            <div>500,000원</div>
                            <div>아이폰12 싸게 팝니다</div>
                        </a>
                        <a href="#">
                            <img src="/web/src/img/시세조회결과 페이지/아이폰12-15.jfif">
                            <div>620,000원</div>
                ...
                <aside class="content--aside__bRight">right</aside>
            </section>
